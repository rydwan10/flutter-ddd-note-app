...
class _$_NoteFormState implements _NoteFormState {
  ...
  @override
  String toString() {
    return 'NoteFormState(note: $note, showErrorMessage: $showErrorMessage, isSaving: $isSaving, isEditing: $isEditing, saveFailureOrSuccessOption: $saveFailureOrSuccessOption)';
  }
